...
def parse_args():
    ...
    parser.add_argument('--test_dir', type=str, required=True, help='包含待显示 PNG 图像的文件夹')
    parser.add_argument('--json', type=str, required=True, help='标签 JSON 文件路径 (根为列表)')
    parser.add_argument('--save_dir', type=str, required=True, help='输出拼图目录')
